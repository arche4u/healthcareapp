...
import { Activity, Calendar, FileText, Settings, Bell, ChevronRight, UserCircle, Users } from "lucide-react";
import { cn } from "@/lib/utils";
import { Button } from "@/components/ui/Button";
import { FaceRegistrationModal } from "@/components/patient/FaceRegistrationModal";

const navItems = [
  { name: "My Dashboard", href: "/patient", icon: Activity },
  { name: "Health Records", href: "/patient/records", icon: FileText },
  { name: "Family", href: "/patient/family", icon: Users },
        ...
        <div className="p-4 border-t border-border">
          <Link href="/auth/signin" className="flex items-center gap-3 px-3 py-2 rounded-lg text-sm text-muted-foreground hover:text-foreground hover:bg-accent transition-colors">
            ...
            <div className="flex-1 text-left">
              <p className="font-medium truncate">{user?.full_name || "Patient"}</p>
