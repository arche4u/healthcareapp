...
import { User, Mail, Lock, Save, Loader2, CheckCircle, AlertCircle, Shield, Bell, Eye, EyeOff, Palette } from "lucide-react";
...
export default function SettingsPage() {
  ...
  return (
    <div className="p-6 max-w-2xl mx-auto space-y-8">
      ...
      {/* Appearance section */}
      <SectionCard title="Appearance" description="Customize colors and display mode." icon={Palette}>
        <ThemeSwitcher />
      </SectionCard>
